...
### Some runouts:
**example** 
![](../../images/lab10/example_runout.png)


## Спрашивается - нафига козе баян? Ну... 
#### Прога это в целом типы данных и алгоритмы для жонглирования/аркестрирования этими самыми дататайпами. Крч, оптимизация эт важно и чем бы дитё не тешилось, лишь бы оптимизация проекта не страдала. Так что финк эбаут...

![](../../images/lab10/howitworks.jpeg)